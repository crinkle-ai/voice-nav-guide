      ...
      <DialogContent className="sm:max-w-lg p-0 overflow-hidden">
        <div className="bg-[#131F69] px-6 py-4 text-white">
          ...
          <DialogDescription className="text-xs text-white/80 mt-1">
            {user
              ? "Saved to your UHC account in HIPAA-secure member systems."
              : "Kept only on this device until you sign in and save to your UHC account."}
          </DialogDescription>
        </div>
        ...
        <div className="px-6 py-5 space-y-4">
          ...
          <div>
            ...
            <ul className="text-sm text-ink/80 space-y-1 pl-4 list-disc">
              <li>Only you, when signed in to your UHC account</li>
              <li>Any UHC agent you call from this workspace</li>
          ...
          <div className="flex flex-col gap-2">
            ...
            >
              UHC Notice of Privacy Practices <ExternalLink className="h-3 w-3" />
            </a>
          </div>
        </div>
          ...
          <AlertDialogContent>
            <AlertDialogHeader>
              ...
              <AlertDialogDescription>
                ...
                {user ? " and from your UHC account" : ""}. This cannot be undone.
              </AlertDialogDescription>
            </AlertDialogHeader>
            <AlertDialogFooter>
