...
export function LiveAdvisePanel() {
  ...
  return (
    <div className="fixed bottom-44 right-4 z-[50] flex max-h-[calc(100vh-12rem)] w-[420px] max-w-[calc(100vw-2rem)] flex-col overflow-hidden rounded-2xl border-2 border-emerald-500/40 bg-card shadow-2xl shadow-emerald-500/20 animate-in slide-in-from-bottom-4 duration-300">
      {/* Header: agent video tile */}
      <div className="relative min-h-[180px] flex-1 overflow-hidden bg-gradient-to-br from-emerald-900 to-emerald-700">
        <img
          src={agent.avatar}
          alt={agent.name}
          className={cn(
