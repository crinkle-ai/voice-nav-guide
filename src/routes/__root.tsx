...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "CrinkleHealth" },
      { name: "description", content: "A chat-based shopping experience that captures and validates consumer information to recommend the best Medicare Advantage or Medigap + Part D plan options" },
      { name: "author", content: "Lovable" },
      { name: "theme-color", content: "#4CAF50" },
      { property: "og:title", content: "CrinkleHealth" },
      { property: "og:description", content: "A chat-based shopping experience that captures and validates consumer information to recommend the best Medicare Advantage or Medigap + Part D plan options" },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "CrinkleHealth" },
      { name: "twitter:description", content: "A chat-based shopping experience that captures and validates consumer information to recommend the best Medicare Advantage or Medigap + Part D plan options" },
      { property: "og:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/R0SnWfSyqCUnQVnt3DhUUe9aEfW2/social-images/social-1782922399404-Screenshot_2026-07-01_at_11.12.54_AM.webp" },
      { name: "twitter:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/R0SnWfSyqCUnQVnt3DhUUe9aEfW2/social-images/social-1782922399404-Screenshot_2026-07-01_at_11.12.54_AM.webp" },
    ],
    links: [
      {
        rel: "stylesheet",
