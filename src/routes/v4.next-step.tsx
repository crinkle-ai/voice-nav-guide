...
export const Route = createFileRoute("/v4/next-step")({
  head: () => ({ meta: [{ title: "Next step — Medicare Compass v4" }] }),
    ...
    <AppShell step="next">
      ...
      <div className="max-w-2xl">
        ...
        <div className="mt-8 grid sm:grid-cols-2 gap-4">
          <a href="tel:+18005551234" className="rounded-2xl border border-line bg-paper p-5 hover:border-accent transition group">
          ...
          <button onClick={() => window.print()} className="text-left rounded-2xl border border-line bg-paper p-5 hover:border-accent transition">
        ...
        <div className="mt-10 flex items-center gap-3">
          <Link to="/v4">
            <Button variant="outline" onClick={reset}>
              <RotateCcw className="h-4 w-4 mr-2" /> Try another experience
            </Button>
          </Link>
        </div>
      </div>
