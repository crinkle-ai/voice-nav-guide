...
Five UHC-style Medicare Advantage plans hand-tuned for the Twin Cities market.

| # | Plan | Type | Premium | Deductible | MOOP | Notes |
|---|---|---|---|---|---|---|
| 1 | UHC AARP Medicare Advantage Choice Plan 1 | MA-HMO | $0 | $0 | $4,900 | Narrow Allina/Fairview network |
| 2 | UHC AARP Medicare Advantage Patriot | MA-HMO | $0 | $0 | higher copays | Broadest local HMO network |
| 3 | UHC AARP Medicare Advantage Choice | MA-PPO | $39 | low | $6,700 | Nationwide PPO |
| 4 | UHC AARP Medicare Advantage Plan 2 | MA-PPO | $89 | $0 | $4,500 | Rich extras (dental / vision / hearing) |
| 5 | UHC Dual Complete MN-Y001 | D-SNP | $0 | $0 | $0 | **Requires Medicaid**; OTC + transportation |
...
- Editing real UHC plan PDFs or pulling live CMS formularies — values are hand-curated for narrative coherence.
